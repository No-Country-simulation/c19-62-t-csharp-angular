...
namespace Backend.Controllers
{
    ...
    [ApiController]
    public class CourseModuleController(CourseModuleService courseModul, ILogger<CourseModuleController> logger, ApplicationDbContext context) : ControllerBase
    {
        private readonly CourseModuleService _courseModule = courseModul;
        private readonly ILogger<CourseModuleController> _logger = logger;
