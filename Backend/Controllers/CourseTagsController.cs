...
namespace Backend.Controllers
{
    ...
    [ApiController]
    public class CourseTagsController(CourseTagsService courseTagsService, ILogger<CourseTagsController> logger, ApplicationDbContext context) : ControllerBase
    {
        private readonly CourseTagsService _courseTagsService = courseTagsService;
