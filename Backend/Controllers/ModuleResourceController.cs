...
namespace Backend.Controllers
{
     ...
     [ApiController]
    public class ModuleResourceController:ControllerBase
    {
         private readonly ModuleResourceService _moduleResourceService;
        private readonly ILogger<ModuleResourceController> _logger;

        private readonly ApplicationDbContext _context; 

        public ModuleResourceController(ModuleResourceService moduleResourceService,ILogger<ModuleResourceController> logger,ApplicationDbContext context){
            _moduleResourceService= moduleResourceService;
            _logger= logger;
            _context=context;
        }
